...
userRouter.post("/images", verifyToken, async (req, res) => {
  try {
...
userRouter.get("/images/:imageId", verifyToken, async (req, res) => {
  try {
...
userRouter.get("/images", verifyToken, async (req, res) => {
  try {
...
userRouter.put("/images/:imageId/description", verifyToken, async (req, res) => {
  try {
...
userRouter.put("/images/:imageId/tags", verifyToken, async (req, res) => {
  try {
